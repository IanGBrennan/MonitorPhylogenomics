...
SESras <- readRDS(file="~/Documents/GitHub/MonitorPhylogenomics/SimulatedGoanna_RaoQ_logData_SES_raster.RDS")
```
...
saveRDS(SESras, file="~/Documents/GitHub/MonitorPhylogenomics/SimulatedGoanna_RaoQ_logData_SES_raster.RDS")
```
...
SESras <- readRDS(file="~/Documents/GitHub/MonitorPhylogenomics/SimulatedMarsupial_RaoQ_logData_SES_raster.RDS")
```
...
SESras <- readRDS(file="~/Documents/GitHub/MonitorPhylogenomics/SimulatedBoth_RaoQ_logData_SES_raster.RDS")
```
